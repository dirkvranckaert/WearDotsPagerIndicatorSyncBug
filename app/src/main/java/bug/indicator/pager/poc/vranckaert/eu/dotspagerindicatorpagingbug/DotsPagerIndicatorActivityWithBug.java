...
public class DotsPagerIndicatorActivityWithBug extends Activity {
    private View mContainer;
    private GridViewPager mViewPager;
    private DotsPageIndicator mViewPagerIndicator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPagerIndicator = (DotsPageIndicator) findViewById(R.id.view_pager_indicator);
    ...
    private AsyncTask<Void, Void, Void> updateCall = new AsyncTask<Void, Void, Void>() {
        ...
        protected void onPostExecute(Void aVoid) {
            DotsPagerIndicatorActivityWithBug.this.onUpdateCallReturns();
        }
    };
}
