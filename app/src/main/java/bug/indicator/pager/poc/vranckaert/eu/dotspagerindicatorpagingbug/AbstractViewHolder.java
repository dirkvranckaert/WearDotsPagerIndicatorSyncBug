...
public abstract class AbstractViewHolder {
    ...
    public AbstractViewHolder(LayoutInflater inflater, ViewGroup parent, int layoutResource) {
    ...
    protected String getString(int id, String... items) {
        return getResources().getString(id, items);
    }
